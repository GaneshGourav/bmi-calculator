...
console.log(bmiCategory)
    ...
    return <>
    <div style={{display:"flex",justifyContent:"space-evenly",alignItems:"center",marginTop:"30px",border:"1px solid blue"}}>
        <div style={{border:"1px solid teal",padding:"50px",borderRadius:"8px"}}>
...
<Container marginTop={"30px"} padding={"30px"} width={"100%"}>
    ...
    <Input type="number" placeholder={"Enter your Height in m"} onChange={(e)=>setHeight(e.target.value)} /> <br /><br />
    <Input type="number" placeholder={"Enter your weight in Kgs"} onChange={(e)=>setWeight(e.target.value)} /> <br /><br />
    <Button colorScheme="teal" fontFamily={"cursive"} fontWeight={"bold"} width={"100%"} type="submit">Calculate BMI</Button>
    </form>
        ...
        <div>
            <Text color={"teal"} fontFamily={"cursive"} fontWeight={"600"}>
                {bmi?`your latest calculated  Bmi is ${bmi} and 
                ${bmiCategory}
